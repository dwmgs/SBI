CREATE TABLE IF NOT EXISTS sib.bibliotecario (
...
CREATE TABLE IF NOT EXISTS sib.leitor (
...
CREATE TABLE IF NOT EXISTS sbi.livro (
	isbn CHAR (13),
...
CREATE TABLE IF NOT EXISTS sbi.emprestimo (
...
INSERT INTO sib.bibliotecario (nome_bibliotecario, email_bibliotecario, senha_bibliotecario) VALUES ("Bruno Cartaxo", "admin@gmail.com", "12345");
